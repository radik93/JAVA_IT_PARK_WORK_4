...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Transfer transfers4 = new Transfer("Камеди клаб", LocalTime.parse("01:00"),
                LocalTime.parse("02:00"));
        Transfer transfers5 = new Transfer("Наша Раша", LocalTime.parse("02:00"),
                LocalTime.parse("03:00"));
